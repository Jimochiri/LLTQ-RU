...
> :warning: **Внимание:** Перевод не завершен. Проводится построчное добавление текста, появившегося в игре после версии 1.2.24.<br>На данный момент актуализировано `4907` из `15651` строк.
